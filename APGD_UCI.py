...
uci = np.loadtxt('/home/hadoop/Documents/Comparison-Of-Optimization-Algorithms/semeion.data')
print(uci)
print(np.shape(uci))
print(uci[0:1593,0:256])

# Solution Vectors
A = uci[0:1593,0:256]
b_original = uci[:,256:266]
b = np.where(b_original==np.max(b_original))[1]
print(b)
print(np.shape(A))
print(np.shape(b))
